...
// dark:text-white dark:bg-[#0b1727]
const Hero = () => {
	return (
		<header className="py-14 md:py-24 lg:mt-14  text-zinc-900  relative overflow-hidden">
			<Shapes />
				...
				<div className="grid grid-cols-12 gap-6 items-center">
					...
					<div className="col-span-12 lg:col-span-5 relative text-center">
						...
						<div className="relative">
							...
							/>
							<div className="absolute w-[500px] h-[500px] left-0 top-0 bg-slate-100 rounded-full -z-10"></div>
						</div>
					</div>
				</div>
			</div>
